...
const projectInfo = {
  cryptowebsite: {
    ...
    text: {
      ...
      two: 'Ik begon met het ontwerpen van de website. Hiervoor moest ik eerst weten wat er allemaal op de website moest/kon kopen. Dit was afhankelijk van de data die ik kreeg uit mijn API. Ik weet nog weinig van backend omgevingen af, dus zocht ik naar een open api zodat ik geen persoonlijk api-key had die ik moest verbergen. Ik kwam uit op de API CoinGecko. Voor het design heb ik veel inspiratie gehaald uit websites zoals CoinMarketCap.com.',
      three: 'Om te kunnen starten met React, moest ik weten hoe je een project moest opstarten. Dankzij een cursus via Udemy.com die ik voorheen al doorlopen heb werden mij de basis principes van React.js weer duidelijk. Verder was ik tijdens een ander project achter het principe: State Manangement gekomen. Hier wilde ik meer van te weten komen en vond uiteindelijk Redux. Redux is een state management tool waarbij je variabelen of data "globaal" kan opslaan. Mede dankzij verschillende tutorials via youtube begon ik de basis van Redux ook te snappen.',
